...
static gboolean
fpi_byte_writer_put_extension (FpiByteWriter *writer,
...
static gboolean
get_serialized_extensions (TlsSession *self, guint8 **serialized, gsize *serialized_len)
{
...
static gboolean
tls_prf (guint8 *secret, gsize secret_size, const gchar *label, guint label_len, guint8 *seed, guint seed_size, guint8 *out, gsize outsize, const char *hash_algo, GError **error)
{
...
static void
tls_handshake_free (Handshake *msg)
{
  g_free (msg->body);
  g_free (msg->repr);
  g_free (msg);
...
static void
tls_plaintext_free (TlsRecord *record)
{
...
static gboolean
tls_session_handshake_hash (TlsSession *self, guint8 *out, gsize *outlen, GError **error)
{
...
static gboolean
gcm_encrypt (unsigned char *plaintext, int plaintext_len, unsigned char *aad, int aad_len, unsigned char *key, unsigned char *iv, int iv_len, unsigned char *ciphertext, int *ciphertext_len, unsigned char *tag, GError **error)
{
  int len, discard_len;
...
static gboolean
gcm_decrypt (unsigned char *ciphertext, int ciphertext_len, unsigned char *aad, int aad_len, unsigned char *tag, unsigned char *key, unsigned char *iv, int iv_len, unsigned char *plaintext, gsize *plaintext_len, GError **error)
{
  int len, discard_len;
...
static gboolean
tls_session_encrypt (TlsSession *self, guint8 type, guint8 *ptext, gsize ptext_size, guint8 **ctext, gsize *ctext_size, GError **error)
{
...
static gboolean
tls_session_decrypt (TlsSession *self, guint8 type, guint16 version, guint8 *ctext, gsize ctext_size, guint8 **ptext, gsize *ptext_size, GError **error)
{
...
static gboolean
tls_session_flush_content_buffer (TlsSession *self,
                                  GError **error)
{
  GError *local_error = NULL;
...
gboolean
tls_session_flush_send_buffer (TlsSession *self, guint8 **data, gsize *size, GError **error)
{
  GError *local_error = NULL;
...
static gboolean
tls_session_send (TlsSession *self, TlsRecord *record, GError **error)
{
  GError *local_error = NULL;
...
static gboolean
tls_session_send_alert (TlsSession *self, guint8 level, guint8 description, GError **error)
{
  GError *local_error = NULL;
  FpiByteWriter writer;
  gboolean written = TRUE;
...
gboolean
tls_session_close (TlsSession *self, GError **error)
{
  GError *local_error = NULL;
...
static gboolean
tls_session_send_handshake_msg (TlsSession *self, Handshake *msg, GError **error)
{
  GError *local_error = NULL;
...
static gboolean
tls_session_send_change_cipher_spec (TlsSession *self,
                                     GError **error)
{
  GError *local_error = NULL;
  FpiByteWriter writer;
...
gboolean
tls_session_receive_ciphertext (TlsSession *self, guint8 *data, gsize size, GError **error)
{
  GError *local_error = NULL;
  FpiByteReader reader;
  gboolean read_ok = TRUE;
...
gboolean
tls_session_has_data (TlsSession *self)
{
...
gboolean
tls_session_establish (TlsSession *self, GError **error)
{
  GError *local_error = NULL;
...
gboolean
tls_session_init (TlsSession *self, SensorPairingData *pairing_data, GError **error)
{
...
gboolean
tls_session_wrap (TlsSession *self, guint8 *pdata, gsize pdata_size, guint8 **cdata, gsize *cdata_size, GError **error)
{
  GError *local_error = NULL;
...
gboolean
tls_session_unwrap (TlsSession *self, guint8 *cdata, gsize cdata_size, guint8 **pdata, gsize *pdata_size, GError **error)
{
  GError *local_error = NULL;
  // g_assert(self->established);

...
#define KENSINGTON_VENDOR_ID 0x047d
...
{
  ENROLL_ENROLL_START,
  /* ENROLL_LED_ON is the re-entry point of the per-scan loop so the LED
   * lights up again for every one of the SYNATLSMOC_ENROLL_STAGES scans. */
  ENROLL_LED_ON,
...
typedef enum
{
  IDENTIFY_VERIFY_LED_ON,
  IDENTIFY_VERIFY_SET_EVENT_FINGER_UP,
  IDENTIFY_VERIFY_WAIT_FINGER_UP,
